            ...
            <div className="row" style={divStyle}>
              <div className="col text-center" >
                ...
                <p className="lead text-center">
                  ...
                  Currently, my goal is to build up my endurance to run a 10k!
                </p>
              </div>
              <div className="col text-center">
                ...
                <p className="lead text-center">
                  I am an avid learner, and my favorite medium to learn is through written text. I always try and read something every day. My favorite genre is nonfiction about technology, health research, and biographies.
              ...
              <div className="col text-center">
                ...
                <p className="lead text-center">
                  ...
                  Check out some of my vlogs and advice videos on <a href='https://www.youtube.com/channel/UCd-L5vUAWxnNArskdBkKM6A' target='_blank'>YouTube</a>!
                </p>
              </div>
              <div className="col text-center">
                ...
                <p className="lead text-center">
                  Ever since I was young I loved watching the food network channel and now love to practice what I have learned.
